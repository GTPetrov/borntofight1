...
def _hair(style, hc, hc_l, hc_d):
    ...
    if style == "mohawk":
        return (f'<path d="M64,104 Q60,66 92,50 Q80,80 80,106 Z" fill="{hc_d}" opacity="0.3"/>'
                f'<path d="M156,104 Q160,66 128,50 Q140,80 140,106 Z" fill="{hc_d}" opacity="0.3"/>'
                f'<path d="M95,58 Q92,30 100,20 Q104,26 106,20 Q108,12 112,18 '
                f'Q116,10 118,20 Q122,24 124,20 Q130,34 125,58 '
                f'Q110,50 95,58 Z" fill="{hc}"/>'
                f'<path d="M99,52 Q97,32 104,24 Q110,28 116,24 Q123,34 121,52 Q110,46 99,52 Z" '
                f'fill="{hc_l}" opacity="0.7"/>')
    if style == "long":
